        ...
        layui.use(['form','layer','layedit'], function(){
            ...
            form.on('submit(*)', function(data){
                ...
                if(id != ""){
                    ...
                    //提交表单
                    $.ajax({
                        url:'${base}/frmsApi/frmsApiModify',
                        async:'true',
                        type:'post',
...
<form class="layui-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            <label class="layui-form-label">添加/修改人员：<span style="color:red;">*</span></label>
            <div class="layui-input-inline">
                <input name="writer" type="text" autocomplete="off" id="writer"
                       class="layui-input" value="${frmsUser.name?if_exists}" disabled>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
