...
//                            $("#res ").remove();
                            ...
                            $("#falResponse").val(data.falResponse);
//                                               $("input[name='falResponse']").val(data.falResponse);
                                $("textarea[name='susResponse']").val(data.susResponse);
                                <#--location.href ="${base}/frmsApi/toFrmsApiTest?id="+id;-->
                    ...
                    layer.msg("请求类型和路径不能为空!",function(){
