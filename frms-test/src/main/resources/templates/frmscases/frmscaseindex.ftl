...
//                            ,{field: 'apiName', title: '所属接口', width: 150}
                            , {field: 'caseid', title: '用例id', width: 100}
...
//                            ,{field: 'relresponse', title: '真实返回结果', width: 200}
                            , {field: 'expstatus', title: '期待返回状态码', width: 100}
//                            ,{field: 'expresponse', title: '期待返回结果', width: 100}
                            , {field: 'verifyobj', title: '断言点', width: 150}
                            ,{field: 'verifyresult', title: '执行结果', width: 100,event: 'verifyresult'}
...
//                            ,{field: 'create_time', title: '创建时间', width: 100}
        ...
        $('#addButton').on('click', function () {
            ...
            layer.open({
                ...
                , title: '添加用例'
                , area: ['900px', '700px']
                , content: '${base}/frmsCase/toaddFrmsCases?apiId=' + apiId
        ...
        table.on('tool(entrustOrderFilter)', function (obj) {
            ...
            if (obj.event === 'del') {//删除测试用例
                ...
                layer.open({
                    ...
                    , area: ['800px', '700px']
                    //,btn: ['关闭']
                    , content: '${base}/frmsCase/toFrmsCasesModify?id=' + id
                    , cancel: function (index) {
                        //阻止弹框右上角x掉弹框
            ...
            else if (obj.event === 'verifyresult') {//执行日志
                layer.open({
                    type: 2
                    , title: '执行日志'
                    , area: ['800px', '700px']
...
<#--<script id="remark" type="text/html">-->
    <#--<a class="layui-table-link">${d.verifyresult}</a>-->
<#--</script>-->
<body class="gray-bg">
<div>
    <div class="row">
        ...
        <div class="col-sm-12" style="padding-bottom: 15px;">
            ...
            <#--</div>-->
                <div class="form-group ml30">
                    ...
                    <select id="apiid" class="form-control ml10" style="width: 160px" disabled>
                        <option value="">--请选择--</option>
                    <#if apiIds?exists>
                        <#if apiId?exists> 
                            <#list apiIds as item>  
                                <option value="${apiId}"
                                        <#if apiId == item.id>selected</#if>
                ...
                <div class="form-group ml30">
                    ...
                    <input type="text" class="form-control ml10" id="casename" placeholder="">
                </div>
                <div class="form-group ml30">
