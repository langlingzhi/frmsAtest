        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-6 b-r" style="height:370px">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-navy">报告序号:</label>
                                    <div class="col-sm-5">
                                        <span class="form-control" id="reportId"></span>
                                    </div>
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
    var resultData = {
        "reportId": "1544772811306",
        "testName": "风控日常巡检",
        "testPass": "2",
        "testFail": "1",
        "testSkip": "0",
        "testAll": "3",
        "beginTime": "Dec 14, 2018 3:33:25 PM",
        "totalTime": "5456ms",
        "testResult": [
            {
                "name": "",
    ...
    $(function () {
        $("#reportId").text(resultData["reportId"]);
